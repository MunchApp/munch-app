...
//    private Search(View root, MapFragment mapFrag) {
//        view = root;
...
//    public static Search getInstance(View root, MapFragment mapfrag) {
//        if (search_instance == null)
//            search_instance = new Search(root, mapfrag);
//
...
////        SearchListingAdapter mAdapter = new SearchListingAdapter(mapFrag.getActivity(), searchListings);
////        resultsList.setAdapter(mAdapter);
//////        MapFragment.searchListings = searchListings;
////        MapFragment.listing = searchListings;
////        MapFragment.forWindow = searchListings;
////
//////        listing = searchListings;
